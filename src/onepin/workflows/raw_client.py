...
class RawWorkflowsClient:
    ...
    def get_workflow_markdown(
        ...
        *,
        workspace_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ApiResponseWorkflowMarkdownOut]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/workflows/{encode_path_param(workflow_id)}/markdown",
            method="GET",
            headers={
                "X-Workspace-Id": str(workspace_id) if workspace_id is not None else None,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseWorkflowMarkdownOut,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_run_analysis(
        ...
        *,
        workspace_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ApiResponseWorkflowRunAnalysisOut]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/workflows/{encode_path_param(workflow_id)}/runs/{encode_path_param(run_id)}/analysis",
            method="GET",
            headers={
                "X-Workspace-Id": str(workspace_id) if workspace_id is not None else None,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseWorkflowRunAnalysisOut,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def validate_workflow(
        ...
        *,
        ...
        workspace_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[ApiResponseWorkflowValidateOut]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseWorkflowValidateOut,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawWorkflowsClient:
    ...
    async def get_workflow_markdown(
        ...
        *,
        workspace_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiResponseWorkflowMarkdownOut]:
        """
        Render this workflow as a markdown document.
    ...
    async def get_run_analysis(
        ...
        *,
        workspace_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiResponseWorkflowRunAnalysisOut]:
        """
        Fetch delivery, quality and cost analysis for a workflow run.
    ...
    async def validate_workflow(
        ...
        *,
        ...
        workspace_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[ApiResponseWorkflowValidateOut]:
        """
        Validate a workflow `definition` against the FULL run-start bundle, without saving it.
